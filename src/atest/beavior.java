 ...
 */
public class beavior {
    //http://www.1point3acres.com/bbs/thread-195416-1-1.html
    //http://www.1point3acres.com/bbs/thread-275310-1-1.html
    /**
     * 楼主Onsite以后，被要求加面了一轮behavior, 非常懵逼？？？帮忙内推的朋友和我说，这三轮重要程度都是一样的，
     * 写一些楼主之前没有准备到的问题，也在网上查了些资料，希望可以帮助大家。
     ...
     你可以问问身边的朋友看看一般多久久能升一级。回答这个问题的时候，就可以带一句你对公司升级机制的了解，
     希望你2年之内升一级（举例子，我并不知道是不是2年可不可以升啊，不要被我误导）。
     ...
     作为一个New grad, 我的weakness就是缺少中作经验，但是答到这还没完。对于这样的negative question，
     当然要有转折。接下来就要说这不是个问题，我有internship experience, 做过很多projects, tech skills上和team work都有经验，
     不是个大问题，再来句自己是个fast learner。包括正在申请的同学，如果你想转专业，这个也是个很好的回答方式。如果不是new grad的前辈，可以看看下一题的回答。
     ...
     首先，切记！切记！千万不能说之前雇主，同事的问题。即使心里有一万个抱怨，即使是在你看来微不足道的问题，只要是有一点点说 别人的不是，都不是个特别好的回答。
     ...
     I have had problems in the past with taking on too many projects and then not delivering quality and,
     in some cases, not delivering on time. I was simply stretched too thin in too many areas with not enough time
     to deliver in a quality manner. I think that's the opportunity that is there as a new college student,
     ...
     Reference: https://collegegrad.com/tough-in ... r-greatest-weakness  这个问题和之前weakness的问题很相似，
     根据自己的经历，准备好问题都可以变换的回答。

     准备Behavior的问题，按照第一段链接里的16个问题，再准备下所谓的negative quesitons就稳了。
     网上一搜behavior的问题很多很多，但很多都是大同小异。楼主面了无数个面试了，根据自己的经验下面列一下必考题和高频题。
     必考题
