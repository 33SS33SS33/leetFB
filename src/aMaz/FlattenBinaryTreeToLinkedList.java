...
/**
 * Given a binary tree, flattenBinaryTreeToLinkedListb it to a linked list in-place.
 * For example,
 * Given
 * 1
 * / \
...
class FlattenBinaryTreeToLinkedList {
    public static void main(String[] args) {
        ...
        n1.right = n4;
        n2.right = n5;
        new FlattenBinaryTreeToLinkedList().flattenBinaryTreeToLinkedListb(root);
    }
    ...
    public ArrayList<TreeNode> flattenBinaryTreeToLinkedListc(TreeNode root) {
     ...
     */
    public void flattenBinaryTreeToLinkedListb(TreeNode root) {
        while (root != null) {
