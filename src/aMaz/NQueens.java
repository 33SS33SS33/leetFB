...
/**
 * The n-queens puzzle is the problem of placing n queens on an n×n chessboard HARD TODO
...
class NQueens {
    public static void main(String[] args) {
        List<String[]> res = new NQueens().nQueens(4);
        for (String[] l : res) {
            for (String i : l) {
                System.out.println(i);
            }
        }
        System.out.println(new NQueens().nQueens(4));
    }
