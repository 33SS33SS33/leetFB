...
class BinaryTreeLevelOrderTraversalII {
    public static void main(String[] args) {
        ...
        n1.right = n4;
        n2.right = n5;
        System.out.println(new BinaryTreeLevelOrderTraversalII().binaryTreeLevelOrderTraversalII(root).toString());
        System.out.println(new BinaryTreeLevelOrderTraversalII().binaryTreeLevelOrderTraversalIIb(root).toString());
    }
     ...
     */
    public List<List<Integer>> binaryTreeLevelOrderTraversalIIb(TreeNode root) {
