...
/**
 * Created by GAOSHANSHAN835 on 2016/1/18. TODO
 * You are a professional robber planning to houseRobberb houses along a street.
 ...
 * Explanation: Rob house 1 (money = 1) and then houseRobberb house 3 (money = 3).
 * Total amount you can houseRobberb = 1 + 3 = 4.
 * Input: [2,7,9,3,1]  Output: 12
 * Explanation: Rob house 1 (money = 2), houseRobberb house 3 (money = 9) and houseRobberb house 5 (money = 1).
 * Total amount you can houseRobberb = 2 + 9 + 1 = 12.
