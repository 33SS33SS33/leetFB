...
class PathSum2 {
    public static void main(String[] args) {
        ...
        n1.right = n4;
        n2.right = n5;
        System.out.println(new PathSum2().pathSum2a(root, 7).toString());
        System.out.println(new PathSum2().pathSum2b(root, 7).toString());
        System.out.println(new PathSum2().pathSum2b(root, 10).toString());
    ...
    public List<List<Integer>> pathSum2a(TreeNode root, int sum) {
        ...
        pathSum2a(root, sum, currentResult, result);
        return result;
    }

    public void pathSum2a(TreeNode root, int sum, List<Integer> currentResult,
        ...
        if (root.left == null && root.right == null && sum == root.val) {
            ...
            pathSum2a(root.left, sum - root.val, currentResult, result);
            pathSum2a(root.right, sum - root.val, currentResult, result);
        }
     ...
     */
    public List<ArrayList<Integer>> pathSum2b(TreeNode root, int sum) {
